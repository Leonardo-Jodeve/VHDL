...
--               d:/sysclassfiles/orgnization/Ex_8/alu8_verilog/alu8_verilog.srcs/sources_1/ip/barrelshifter8_0/barrelshifter8_0_sim_netlist.vhdl
...
entity barrelshifter8_0_barrelshifter8 is
  port (
  ...
  attribute ORIG_REF_NAME of barrelshifter8_0_barrelshifter8 : entity is "barrelshifter8";
end barrelshifter8_0_barrelshifter8;

architecture STRUCTURE of barrelshifter8_0_barrelshifter8 is
  ...
  signal \u2/tq41\ : STD_LOGIC;
  signal \u2/tq51\ : STD_LOGIC;
  signal \u2/tq61\ : STD_LOGIC;
  signal \u2/tq71\ : STD_LOGIC;
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \q[5]_INST_0_i_1\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \q[6]_INST_0_i_1\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \q[6]_INST_0_i_3\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \q[7]_INST_0_i_4\ : label is "soft_lutpair1";
begin
...
\q[7]_INST_0_i_3\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
    )
        port map (
...
begin
inst: entity work.barrelshifter8_0_barrelshifter8
     port map (
      d(7 downto 0) => d(7 downto 0),
      q(7 downto 0) => q(7 downto 0),
      s(2 downto 0) => s(2 downto 0),
      t(1 downto 0) => t(1 downto 0)
    );
end STRUCTURE;
